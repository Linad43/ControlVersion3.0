...
Если кроме ветки "master" есть другие ветки то перейти на нужную ветку можно с помощью:
...
Для слияния двух веток необходимо воспльзоваться командой:

    git merge <brunchname>

Слияние двух идентичных веток происходит без проблем. А вот слияние различных веток опишем на примере, это ветка с названием "info"

![Branch_info](branch_info.png)

А вот это ветка "master"

![Branch_master](branch_master.png)

И при слиянии возникнет конфликт который нужно решить вручную
